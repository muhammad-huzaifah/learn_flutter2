...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('Welcome to Flutter by Mama Ina')),
        body: Container(
          ...
          child: Column(
            ...
            children: const [
              Text(
                'Flutter - The Complete Guide by Mama ina and Ayah UJeb',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
              ),
              SizedBox(height: 16),
              Text(
                'Learn Flutter step-by-step, from the ground up ayo gas.',
                textAlign: TextAlign.center,
              ),
            ],
          ),
